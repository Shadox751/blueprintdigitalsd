...
export const HVAC_TRACKS = {
  A: {
    ...
    pass:    70,
    open:    true,
    refs:    ["2015 IMC", "2015 IFGC", "Denver Amendments"],
  ...
  B: {
    ...
    pass:    70,
    open:    true,
    refs:    ["2015 IMC", "2015 IFGC", "2015 IRC Mech", "Denver Amendments"],
  ...
  G: {
    ...
    pass:    70,
    open:    true,
    refs:    ["2015 IFGC", "Denver Amendments"],
...
export const HVAC_PRODUCT = {
  ...
  edition: "Built against 2015 IMC + 2015 IFGC (ICC F29 reference). Denver field permits use 2024 IMC as of 2025-06-13 — verify your exam edition with Denver CPD before scheduling.",
};
